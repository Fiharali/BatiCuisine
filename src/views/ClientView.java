    ...
    public void addMaterialToProject(Project project) {
        ...
        while (addingMaterials) {
            ...
            if ("n".equalsIgnoreCase(response)) {
                ...
                addLaborToProject(project , component);
            }
        }
    }

    public void addLaborToProject(Project project , Component component ) {
        ...
        while (addingLabor) {
            ...
            Labor labor = new Labor(component.getName(),"labor", workhours,hourlyrate, productivity);
